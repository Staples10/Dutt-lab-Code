...
New to this version:
 -Binding no longer updates in GUI [causes crashes and difficult to keep track of]
 -Polarity changed in update method with better comments
'''
...
class MCL_NanoDrive(Device):
    ...
    _DEFAULT_SETTINGS = Parameter([Parameter('serial',2850,int,'serial of specific Nano Drive. Dutt labs LP100:2849 & HS3:2850 (20 bit systems)'),
                                   ...
                                   #4 clocks on the back of Nanodrive. Binding does not work with GUI
                                   Parameter('Pixel',[

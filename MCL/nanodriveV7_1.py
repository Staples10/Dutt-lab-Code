...
New to this version:
 ...
 -Make binding/unbinding more intuitive (in gui context, maybe in wrttinig script context too)
...
class MCL_NanoDrive(Device):
    ...
    _DEFAULT_SETTINGS = Parameter([Parameter('serial',2850,int,'serial of specific Nano Drive. Dutt labs LP100:2849 & HS3:2850 (20 bit systems)'),
                                   ...
                                   #4 clocks on the back of Nanodrive
                                   Parameter('Pixel',[
                                        Parameter('mode','low',['low','high'],'low=0, high=1'),
                                        Parameter('polarity','low-to-high',['low-to-high','high-to-low','unbind'],'low-to-high:0, high-to-low:1, unbind to unbind from axis'),
    ...
    def _bind_polarity_fix(self, polarity):
        '''
        Issue where polarity options for BINDING CLOCKS are the opposite of normal polarity options. Documentation is WRONG
